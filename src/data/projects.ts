export interface Project {
  ...
  division: 'FastSoftware' | 'Mobility Infrastructure' | 'Albedo Nodes' | 'Consumer / Experiments'
...
export const projects: Project[] = [
  {
    ...
    tagline: 'Internal tools and AI agents delivered in weeks, not months.',
    ...
    problem: 'Many companies still run critical operations through Excel, email, WhatsApp and disconnected tools. Traditional ERP projects are slow, expensive and difficult to adapt.',
    solution: "FastSoftware builds focused tools and AI-assisted workflows around the company's real processes, then improves them through short deployment cycles.",
    differentiator: 'Instead of forcing companies into a rigid platform, FastSoftware adapts software and agents to the way each company already works.',
    targetUsers: 'Industrial companies, construction companies, procurement teams, operations teams, and SMEs with manual workflows.',
    useCases: ['Lightweight ERP tools for teams that have outgrown spreadsheets', 'Purchasing, logistics and operations dashboards', 'AI agents that prepare reports, surface exceptions and support decisions', 'Workflow automation around existing email, documents and internal systems'],
    businessModel: 'Setup fee for initial build, monthly maintenance, agent usage, and integration work as systems expand.',
    distribution: 'Direct implementation with operators and company leaders who need deployable internal systems quickly.',
    roadmap: { now: 'FastSoftware Sprint offer, custom internal tools, and practical AI workflow deployments.', next: 'Agent templates for purchasing, operations and reporting. Reusable modules for approvals, dashboards and internal portals.', later: 'Private AI deployment options and standardized infrastructure for company-specific agent environments.' },
    trustAndSafety: 'Systems are scoped around company data boundaries, role-based access and practical human review. AI agents assist workflows rather than silently replacing operational decisions.',
    vision: 'Make useful company software deployable in weeks, not years, with agents that adapt to each operating environment.',
  },
  {
    slug: 'alb-parking',
    name: 'ALB Parking',
    logo: 'media/alb-parking/alb-parking-logo.png',
    tagline: 'Parking reservations, access control and operator dashboards for private spaces.',
    ...
    capabilities: [
      ...
      'Camera verified entry and exit',
      'License plate recognition',
      'Gate and door automation',
      'Owner and community dashboards',
    ],
    keyFeatures: [
    ...
    problem: 'Private parking spaces and garage access systems are often disconnected, underused and difficult to control or monetize.',
    solution: 'ALB Parking connects parking reservations, access control, camera verification, gate automation and operator dashboards. It monetizes private spaces while giving communities and small operators better control over who enters.',
    differentiator: 'ALB Parking focuses on the parking operation itself: bookings, permissions, verified entry, automated gates and dashboards for owners, communities and operators.',
  ...
  {
    slug: 'alb-ev-guardian',
    name: 'ALB EV Guardian',
    tagline: 'EV charging consumption and vehicle security alerts for parked cars.',
    positioning: 'ALB EV Guardian monitors EV charging consumption, socket usage and suspicious activity around a parked vehicle, with mobile alerts and future camera or sensor integrations.',
    category: 'B2B',
    division: 'Mobility Infrastructure',
    status: 'Concept',
    parentSlug: 'alb-parking',
    capabilities: ['EV charging consumption', 'Socket usage tracking', 'Vehicle proximity alerts', 'Mobile security notifications', 'Future camera and sensor integrations'],
    problem: 'EV owners and parking operators often cannot see what a connected vehicle is consuming or whether someone is interacting with it while parked.',
    solution: 'ALB EV Guardian links charging sockets, mobile alerts and future camera or sensor integrations so owners and operators can monitor consumption and suspicious activity from the parking environment.',
    differentiator: 'It treats the parking space as a controlled infrastructure point where access, charging and security belong together.',
    targetUsers: 'EV drivers, residential communities, companies with charging spots and parking operators that want stronger control of charging and vehicle security.',
    useCases: ['Tracking electrical consumption per charging session', 'Receiving alerts when someone approaches a parked vehicle', 'Reviewing camera events tied to a parking or charging session', 'Managing socket usage across shared EV parking spaces'],
    businessModel: 'Add-on subscription for ALB Parking operators and premium safety module for EV drivers.',
    distribution: 'Offered through ALB Parking deployments and EV charging partnerships.',
    roadmap: { now: 'Concept validation with parking and EV charging use cases.', next: 'Prototype monitoring flows for consumption, socket usage and proximity events.', later: 'Hardware partner integrations and operator dashboard controls.' },
    trustAndSafety: 'Designed around visible permissions, event logs and user-controlled notifications.',
    vision: 'Make the EV parking space a monitored, useful and secure infrastructure point.',
  },
  {
    slug: 'foreman',
    name: 'Foreman',
  ...
  },
  {
    slug: 'albedo-nodes',
    name: 'Albedo Nodes',
    tagline: 'Local AI boxes now; future distributed compute infrastructure later.',
    positioning: 'Compact compute nodes for local AI agents, private document processing, storage and edge compute, with a later path toward a distributed compute network.',
    category: 'B2B',
    division: 'Albedo Nodes',
    status: 'Concept',
    capabilities: ['Local AI boxes', 'Private document processing', 'Edge compute', 'Storage', 'Node monitoring', 'Future compute network research'],
    keyFeatures: ['Physical node installable in offices, garages, small companies or technical home environments', 'Local AI agents for private operational workflows', 'Document processing and storage close to the company data source', 'Monitoring dashboard for capacity, jobs and health', 'Research path toward a distributed compute marketplace for unused capacity'],
    problem: 'Companies increasingly need AI and automation, but cloud-only systems can be expensive, opaque or unsuitable for private operational data.',
    solution: 'Albedo Nodes is developing local compute boxes that can run private AI agents, process documents locally and provide edge capacity first. Later, the research path is a distributed network where owners may monetize unused capacity.',
    differentiator: 'Instead of treating infrastructure as something only large cloud providers own, Albedo Nodes explores smaller, deployable compute units that can live close to the user.',
    targetUsers: 'SMEs, technical teams, AI-heavy companies, home lab users and future node operators.',
    useCases: ['Running private company agents close to internal documents and workflows', 'Processing sensitive files locally before syncing only required outputs', 'Providing edge compute for offices, garages and small facilities', 'Monitoring compute, storage and inference capacity from a local node dashboard'],
    businessModel: 'Hardware sale or lease, managed software subscription and support plans first. Future revenue share may be explored if unused capacity joins a distributed compute network.',
    distribution: 'Initial deployments with companies that need private AI and local automation, followed by technical operators and future node hosts.',
    roadmap: { now: 'Local AI box prototype and private company agent runtime research.', next: 'Monitoring dashboard, storage workflows and document processing deployments.', later: 'Distributed compute marketplace research and node operator economics.' },
    trustAndSafety: 'Local-first processing is designed to reduce unnecessary data movement. Future network participation would require explicit owner controls, workload isolation and transparent usage reporting.',
    vision: 'Make local compute deployable for companies and eventually connect distributed capacity into a practical infrastructure network.',
  },
