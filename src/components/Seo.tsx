...
export default function Seo() {
  ...
  useEffect(() => {
    ...
    if (pathname === '/') graph.unshift({ '@type': 'Organization', '@id': `${SITE_URL}/#organization`, name: 'ALBEDO Industries', url: `${SITE_URL}/`, description: 'An early-stage company focused primarily on data-center and AI-infrastructure development through Project Atlas, with longer-term orbital-compute research, persistent physical interfaces and operational software.', knowsAbout: ['Data-center development', 'AI infrastructure', 'Orbital compute research', 'Persistent operational displays', 'Operational software'], logo: `${SITE_URL}/favicon.svg`, founder: { '@type': 'Person', name: 'Alex Velasco' } }, { '@type': 'WebSite', '@id': `${SITE_URL}/#website`, name: 'ALBEDO Industries', url: `${SITE_URL}/`, publisher: { '@id': `${SITE_URL}/#organization` } })
