...
const countries: Record<string,string>={spain:'Spain',portugal:'Portugal',germany:'Germany',france:'France',sweden:'Sweden',finland:'Finland',norway:'Norway',poland:'Poland'}
