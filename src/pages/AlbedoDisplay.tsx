...
export default function AlbedoDisplay() {
  ...
  return <article className="ad-page ad-landing">
    <ProductNavigation />
    <header className="ad-hero"><div className="ad-wrap ad-hero__grid"><div className="ad-hero__copy"><span className="ad-status">Concept · component validation</span><p className="ad-kicker">PHONE-POWERED · PERSISTENT · FOCUSED</p><h1>A simple display for information that should stay visible.</h1><p className="ad-lede">Albedo Display is a proposed small screen for workplace instructions and status. Your phone creates the update, Bluetooth sends it, and the display keeps it in view.</p><div className="ad-actions"><DisplaySectionLink section="pilot">Apply for a pilot</DisplaySectionLink><DisplaySectionLink className="secondary" section="works">See how it works</DisplaySectionLink></div><p className="ad-hero__secondary">Exploring the project? <Link to="/display/invest">Read the investor brief</Link>.</p></div><div className="ad-hero__product"><DisplayAssetFigure asset={displayAssets.v0Concept} className="ad-hero__asset" priority /><div className="ad-screen-tabs" aria-label="Example display states"><span>Room status</span><span>Next task</span><span>Operational alert</span></div><p className="ad-concept-label">Illustrative concept — not a working prototype.</p></div></div></header>
